...
public class DocumentFrequency {
	...
	public static String stopwords_path = "/home/maninandadeep/Desktop/sem-8/nosql/Assignment2/AdditionalMR";
	...
	public static class DocFreqMapper extends Mapper<Object, Text, Text, Text> {
		...
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			...
			try {
				// reading and storing the stop words from stopwords.txt file
				  FileReader fileReader = new FileReader(stopwords_path+"/stopwords.txt");
			...
			for (String token : tokens) {
				...
				{
					// ignoring the stopwords and setting the stemmed word.
	...
	public static void main(String[] args) throws Exception {
        ...
        File newFile = new File(args[1]+"/DF.tsv");
